...
<?php
	...
	$query = "SELECT * FROM manufacture ORDER BY image_id DESC";
   ...
   <td><img src="../files/manufactures/'.$row["image_name"].'" class="img-thumbnail" width="50" height="15" /></td>
